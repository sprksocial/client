...
- [Learn More](https://spark-social-learn-more.com)
      ...
      Install homebrew to install flutter to run flutter to run my app
    Install flutter to run flutter to run my app.
  Attempt flutter run to run my app.
    Attempt to install cocoapods to run flutter to run my app.
      Install Ruby to install cocoapods with gem to flutter to run my app.
    Attempt again to install cocoapods with gem to run flutter to run my app.
      Install older securerandom version to install cocoapods with gem to run flutter to run my app.
    Attempt again to install cocoapods with gem to run flutter to run my app.
      Install older drb version to install cocoapods to run flutter to run my app.
    Attempt again to install cocoapods with gem to run flutter to run my app.
      Attempt to install older activesupport version to install cocoapods to run flutter to run my app.
        Install older zeitwerk version to install activesupport to install cocoapods to run flutter to run my app.
      Install older activesupport version to install cocoapods to run flutter to run my app.
    Install cocoapods with gem to run flutter to run my app.
  Attempt flutter run to run my app.
      Uninstall cocoapods with gem to reinstall cocoapods with homebrew to run flutter to run my app.
    Reinstall cocoapods with homebrew to run flutter to run my app.
  Run flutter run to run my app.
Run my app.
