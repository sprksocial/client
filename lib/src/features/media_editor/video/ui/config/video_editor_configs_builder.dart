...
import 'package:spark/src/features/media_editor/video/ui/widgets/clip/clip_editor_bar.dart';
import 'package:spark/src/features/media_editor/video/ui/widgets/clip/clips_editor_bar.dart';
import 'package:spark/src/features/media_editor/canvas/ui/widgets/sticker_picker.dart';
import 'package:spark/src/features/media_editor/video/ui/widgets/common/video_progress_alert.dart';
import 'package:spark/src/features/media_editor/canvas/ui/widgets/crop_rotate/crop_rotate_editor_bar.dart';
...
import 'package:spark/src/features/media_editor/video/ui/widgets/timeline/story_video_timeline_controls.dart';
import 'package:spark/src/features/media_editor/canvas/ui/widgets/tune/tune_editor_bar.dart';
...
class VideoEditorConfigsBuilder {
  ...
  static ProImageEditorConfigs buildStory({
    ...
    return _build(
      ...
      mainEditorWidgets: StoryEditorProfile.buildMainEditorWidgets(
        onMention: onMention,
        onDone: onDone,
        contextualControlBuilder: (editor) => StoryVideoTimelineControls(
          editor: editor,
  ...
  static ProImageEditorConfigs _build({
    ...
    required VideoEditorConfigs videoEditorConfigs,
    EditorSafeArea safeArea = const EditorSafeArea(),
      ...
      dialogConfigs: DialogConfigs(
        widgets: DialogWidgets(
          loadingDialog: (message, configs) => VideoProgressAlert(
            progress: processingService.progressFor(taskId),
          ),
        ),
      ),
      theme: ThemeData(
