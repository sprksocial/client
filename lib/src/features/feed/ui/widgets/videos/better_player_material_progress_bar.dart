...
class _VideoProgressBarState extends State<BetterPlayerMaterialVideoProgressBar> {
  ...
  Widget build(BuildContext context) {
    final enableProgressBarDrag = betterPlayerController!.betterPlayerConfiguration.controlsConfiguration.enableProgressBarDrag;
...
class _ProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var playedPartPercent = value.position.inMilliseconds / value.duration!.inMilliseconds;
