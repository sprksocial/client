...
import 'package:sparksocial/src/features/profile/data/models/profile_state.dart';
...
class Profile extends _$Profile {
  ...
  Future<AuthorFeedResponse?> getProfileVideosSprk({int limit = 50, String? cursor}) async {
    try {
      return await _profileRepository.getProfileVideosSprk(_did, limit: limit, cursor: cursor);
    } catch (e) {
  ...
  Future<AuthorFeedResponse?> getProfileVideosBsky({int limit = 50, String? cursor}) async {
    try {
      return await _profileRepository.getProfileVideosBsky(_did, limit: limit, cursor: cursor);
    } catch (e) {
  ...
  Future<void> updateProfile({required String displayName, required String description, dynamic avatar}) async {
    try {
      await _profileRepository.updateProfile(displayName: displayName, description: description, avatar: avatar);
      refreshProfile();
    } catch (e) {
