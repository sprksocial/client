...
//   final List<StoriesByAuthor> storiesByAuthor;

//   const AllStoriesPage({super.key, required this.storiesByAuthor});

//   @override
//   State<AllStoriesPage> createState() => _AllStoriesPageState();
// }

// class _AllStoriesPageState extends State<AllStoriesPage> with TickerProviderStateMixin {
