...
class _$SplashStateImpl implements _SplashState {
  const _$SplashStateImpl({this.isImageLoaded = false});
  ...
  @override
  String toString() {
    return 'SplashState(isImageLoaded: $isImageLoaded)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isImageLoaded, isImageLoaded) ||
                other.isImageLoaded == isImageLoaded));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isImageLoaded);
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({final bool isImageLoaded}) = _$SplashStateImpl;
