...
class DemoBuildStickers extends StatelessWidget {
  ...
  final List<String> demoTitles = ['Recent', 'Favorites', 'Shapes', 'Funny', 'Boring', 'Frog', 'Snow', 'More'];
  @override
  Widget build(BuildContext context) {
    final slivers = <Widget>[];
    var offset = 0;
    for (final element in demoTitles) {
      slivers.addAll([
        SliverPadding(
  ...
  SliverGrid _buildDemoStickers(
    ...
    return SliverGrid.builder(
      ...
      itemBuilder: (context, index) {
        final url = 'https://picsum.photos/id/${offset + (index + 3) * 3}/2000';
