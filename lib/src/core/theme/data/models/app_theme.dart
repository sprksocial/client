...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      bodyLarge: TextStyle(fontWeight: FontWeight.normal, color: AppColors.textPrimary),
      bodyMedium: TextStyle(fontWeight: FontWeight.normal, color: AppColors.textPrimary),
      bodySmall: TextStyle(fontWeight: FontWeight.normal, color: AppColors.textPrimary),
      ...
      labelSmall: TextStyle(fontWeight: FontWeight.w500, color: AppColors.textPrimary),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    useMaterial3: true,
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textLight),
      displayMedium: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textLight),
      displaySmall: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textLight),
      headlineLarge: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textLight),
      headlineMedium: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textLight),
      headlineSmall: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textLight),
      titleLarge: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textLight),
      titleMedium: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textLight),
      titleSmall: TextStyle(fontWeight: FontWeight.w600, color: AppColors.textLight),
      bodyLarge: TextStyle(fontWeight: FontWeight.normal, color: AppColors.textLight),
      bodyMedium: TextStyle(fontWeight: FontWeight.normal, color: AppColors.textLight),
      bodySmall: TextStyle(fontWeight: FontWeight.normal, color: AppColors.textLight),
      labelLarge: TextStyle(fontWeight: FontWeight.w500, color: AppColors.textLight),
      labelMedium: TextStyle(fontWeight: FontWeight.w500, color: AppColors.textLight),
      labelSmall: TextStyle(fontWeight: FontWeight.w500, color: AppColors.textLight),
    ),
    splashColor: Colors.transparent,
    highlightColor: Colors.transparent,
    hoverColor: Colors.transparent,
