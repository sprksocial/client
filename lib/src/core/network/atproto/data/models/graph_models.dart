...
abstract class FollowsResponse with _$FollowsResponse {
  ...
  factory FollowsResponse.fromJson(Map<String, dynamic> json) =>
      _$FollowsResponseFromJson(json);
}

@freezed
abstract class FollowUserResponse with _$FollowUserResponse {
  const factory FollowUserResponse({required String uri, required String cid}) =
      _FollowUserResponse;
...
abstract class BlockUserResponse with _$BlockUserResponse {
  const factory BlockUserResponse({required String uri, required String cid}) =
      _BlockUserResponse;
