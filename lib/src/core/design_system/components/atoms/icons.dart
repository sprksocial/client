...
enum AppIconData {
  ...
  sideShare('share.svg'),
  gear('gear.svg'),
  warning('temp/warning.svg'),
  offline('temp/offline.svg'),
  person('temp/person.svg'),
  people('temp/people.svg'),
  notifications('temp/notifications.svg'),
  delete('temp/delete.svg'),
  block('temp/block.svg'),
  check('temp/check.svg'),
  history('temp/history.svg'),
  pause('temp/pause.svg'),
  undo('temp/undo.svg'),
  video('temp/video.svg'),
  mediaUnavailable('temp/media_unavailable.svg'),
  hidden('temp/hidden.svg'),
  edit('temp/edit.svg'),
  sticker('temp/sticker.svg'),
  effects('temp/effects.svg'),
  blur('temp/blur.svg'),
  crop('temp/crop.svg'),
  layersForward('temp/layers_forward.svg'),
  waveform('temp/waveform.svg'),
  volumeOff('temp/volume_off.svg'),
  drag('temp/drag.svg'),
  move('temp/move.svg'),
  selectionSingle('temp/selection_single.svg'),
  alignLeft('temp/align_left.svg'),
  alignCenter('temp/align_center.svg'),
  alignRight('temp/align_left.svg', mirror: true),
  circle('temp/circle.svg'),
  rectangleFilled('temp/rectangle_filled.svg'),
  eraser('temp/eraser.svg'),
  rotate('temp/rotate.svg'),
  shield('temp/shield.svg'),
  externalLink('temp/external_link.svg'),
  document('temp/document.svg'),
  signOut('temp/sign_out.svg'),
  key('temp/key.svg'),
  redo('temp/undo.svg', mirror: true),
  layersBackward('temp/layers_forward.svg', quarterTurns: 2),
...
class AppIcons {
  ...
  static Widget download({double size = 24, Color? color}) =>
      _asset(AppIconData.download, size: size, color: color);
