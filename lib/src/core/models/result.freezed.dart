...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message, Exception? exception) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(String message, Exception? exception)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl(this.message, [this.exception]);
...
abstract class Failure<T> implements Result<T> {
  const factory Failure(final String message, [final Exception? exception]) =
      _$FailureImpl<T>;
