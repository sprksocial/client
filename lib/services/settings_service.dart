...
class SettingsService extends ChangeNotifier {
  ...
  bool _hideAdultContent = true;  // On by default
  ...
  Map<String, Map<String, String>> get labelPreferences => 
      Map.unmodifiable(_labelPreferences);
  ...
  Future<void> _loadSettings() async {
    ...
    if (prefsJson != null) {
      ...
      _labelPreferences = decoded.map((key, value) => MapEntry(
          key,
  ...
  Future<void> removeLabelPreference(
    String labelerDid,
    String labelValue
  ) async {
    if (_isLoading) await _loadSettings();
